  ...
  "node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    (function() {
      ...
      function validateChildKeys(node) {
        isValidElement15(node) ? node._store && (node._store.validated = 1) : "object" === typeof node && null !== node && node.$$typeof === REACT_LAZY_TYPE && ("fulfilled" === node._payload.status ? isValidElement15(node._payload.value) && node._payload.value._store && (node._payload.value._store.validated = 1) : node._store && (node._store.validated = 1));
      }
      ...
      exports.useState = function(initialState15) {
        return resolveDispatcher().useState(initialState15);
      };
  ...
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    (function() {
      ...
      exports.useFormState = function(action, initialState15, permalink) {
        return resolveDispatcher().useFormState(action, initialState15, permalink);
      };
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React41 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is4, useState14 = React41.useState, useEffect19 = React41.useEffect, useLayoutEffect9 = React41.useLayoutEffect, useDebugValue2 = React41.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React41 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = shim.useSyncExternalStore, useRef19 = React41.useRef, useEffect19 = React41.useEffect, useMemo11 = React41.useMemo, useDebugValue2 = React41.useDebugValue;
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React41 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = React41.useSyncExternalStore, useRef19 = React41.useRef, useEffect19 = React41.useEffect, useMemo11 = React41.useMemo, useDebugValue2 = React41.useDebugValue;
      exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
        var instRef = useRef19(null);
        if (null === instRef.current) {
          var inst = { hasValue: false, value: null };
      ...
      function exp(x2, sd) {
        ...
        for (; ; ) {
          ...
          if (digitsToString(t.d).slice(0, wpr) === digitsToString(sum.d).slice(0, wpr)) {
            while (k2--) sum = round2(sum.times(sum), wpr);
            Ctor.precision = pr;
...
function getUniqPayload(payload, option, defaultUniqBy2) {
  if (option === true) {
    return (0, import_uniqBy.default)(payload, defaultUniqBy2);
  }
...
var getStackedData = (data, dataKeys, offsetType) => {
  ...
  result.forEach((series, seriesIndex) => {
    series.forEach((point4, pointIndex) => {
...
var ResponsiveContainerContext = /* @__PURE__ */ (0, import_react10.createContext)(defaultResponsiveContainerProps.initialDimension);
...
var ResponsiveContainer = /* @__PURE__ */ (0, import_react10.forwardRef)((props, ref) => {
...
function lodashLikeSortBy(array, itemSorter) {
  ...
  return (0, import_sortBy3.default)(array, itemSorter);
}
var DefaultTooltipContent = (props) => {
  ...
  var finalStyle = _objectSpread6(_objectSpread6({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function usePrefersReducedMotion() {
  var [prefersReducedMotion, setPrefersReducedMotion] = (0, import_react12.useState)(() => {
    if (Global.isSsr) {
      return false;
    }
...
function TooltipBoundingBoxImpl(props) {
  ...
  if (state.dismissed && (((_props$coordinate$x2 = (_props$coordinate5 = props.coordinate) === null || _props$coordinate5 === void 0 ? void 0 : _props$coordinate5.x) !== null && _props$coordinate$x2 !== void 0 ? _props$coordinate$x2 : 0) !== state.dismissedAtCoordinate.x || ((_props$coordinate$y2 = (_props$coordinate6 = props.coordinate) === null || _props$coordinate6 === void 0 ? void 0 : _props$coordinate6.y) !== null && _props$coordinate$y2 !== void 0 ? _props$coordinate$y2 : 0) !== state.dismissedAtCoordinate.y)) {
    setState(_objectSpread7(_objectSpread7({}, state), {}, {
      dismissed: false
    }));
  }
  var {
  ...
  var positionStyle = props.hasPortalFromProps ? {} : _objectSpread7(_objectSpread7({
...
var getPath = (_ref2) => {
  ...
  if (Array.isArray(baseLine)) {
    ...
    if (layout === "vertical") {
      _lineFunction = area_default().y(getY).x1(getX).x0((d) => d.base.x);
    } else {
      _lineFunction = area_default().x(getX).y1(getY).y0((d) => d.base.y);
    }
...
function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
  ...
  var timingStyle = interKeys.reduce((res, key) => {
    ...
    return _objectSpread11(_objectSpread11({}, res), {}, {
...
// node_modules/recharts/es6/animation/useAnimationManager.js
var AnimationManagerContext = /* @__PURE__ */ (0, import_react13.createContext)(createDefaultAnimationManager);
function useAnimationManager(animationId, animationManagerFromProps) {
  var contextAnimationManager = (0, import_react13.useContext)(AnimationManagerContext);
  return (0, import_react13.useMemo)(() => animationManagerFromProps !== null && animationManagerFromProps !== void 0 ? animationManagerFromProps : contextAnimationManager(animationId), [animationId, animationManagerFromProps, contextAnimationManager]);
}
...
function JavascriptAnimate(outsideProps) {
  ...
  var [style, setStyle] = (0, import_react14.useState)(isActive ? from : to);
  var stopJSAnimation = (0, import_react14.useRef)(null);
...
var Rectangle = (rectangleProps) => {
  ...
  var prevWidthRef = (0, import_react16.useRef)(width);
  var prevHeightRef = (0, import_react16.useRef)(height);
  var prevXRef = (0, import_react16.useRef)(x2);
  var prevYRef = (0, import_react16.useRef)(y2);
  var animationIdInput = (0, import_react16.useMemo)(() => ({
    x: x2,
    y: y2,
    width,
    height,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
  ...
  return _objectSpread14(_objectSpread14({}, implicitAngleAxis), {}, {
    type: evaluatedType
  });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
  ...
  return _objectSpread14(_objectSpread14({}, implicitRadiusAxis), {}, {
    type: evaluatedType
  });
});
...
var selectSortedDataPoints = createSelector([selectAllAppliedValues], (appliedData) => {
  return appliedData === null || appliedData === void 0 ? void 0 : appliedData.map((item) => item.value).sort(sortBy4);
});
...
var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
  ...
  if (entry) {
    if (layout === "centric") {
      ...
      return _objectSpread19(_objectSpread19(_objectSpread19({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
        angle: _angle,
        radius: _radius
      });
    }
    ...
    return _objectSpread19(_objectSpread19(_objectSpread19({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
      angle,
      radius
    });
  }
...
var seed = {};
var initialState4 = {
  zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current3) => _objectSpread20(_objectSpread20({}, acc), {}, {
    [current3]: {
      element: void 0,
...
function ZIndexLayer(_ref2) {
  ...
  var isPanorama = useIsPanorama();
  var lastPortalElementRef = (0, import_react17.useRef)(void 0);
  var registeredZIndexesRef = (0, import_react17.useRef)(/* @__PURE__ */ new Set());
  var dispatch = useAppDispatch();
...
function RenderCursor(_ref2) {
  ...
  if (/* @__PURE__ */ (0, import_react18.isValidElement)(cursor)) {
    return /* @__PURE__ */ (0, import_react18.cloneElement)(cursor, cursorProps);
  }
  return /* @__PURE__ */ (0, import_react18.createElement)(cursorComp, cursorProps);
}
function CursorInternal(props) {
  ...
  var cursorProps = _objectSpread21(_objectSpread21(_objectSpread21(_objectSpread21({
    stroke: "#ccc",
    pointerEvents: "none"
...
var TooltipPortalContext = /* @__PURE__ */ (0, import_react19.createContext)(null);
    ...
    var listener2 = (incomingSyncId, action, emitter) => {
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          ...
          var scaledCoordinate = _objectSpread22(_objectSpread22({}, otherCoordinateProps), {}, {
            x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
            y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
          });
          dispatch(_objectSpread22(_objectSpread22({}, action), {}, {
            payload: _objectSpread22(_objectSpread22({}, action.payload), {}, {
...
function Tooltip(outsideProps) {
  ...
  var tooltipContentProps = _objectSpread23(_objectSpread23({}, props), {}, {
...
var Text = /* @__PURE__ */ (0, import_react22.forwardRef)((outsideProps, ref) => {
...
var CartesianLabelContext = /* @__PURE__ */ (0, import_react23.createContext)(null);
var CartesianLabelContextProvider = (_ref2) => {
  ...
  var viewBox = (0, import_react23.useMemo)(() => ({
    x: x2,
    y: y2,
    upperWidth,
    lowerWidth,
...
var useCartesianLabelContext = () => {
  var labelChildContext = (0, import_react23.useContext)(CartesianLabelContext);
  var chartContext = useViewBox();
  return labelChildContext || (chartContext ? cartesianViewBoxToTrapezoid(chartContext) : void 0);
};
var PolarLabelContext = /* @__PURE__ */ (0, import_react23.createContext)(null);
var usePolarLabelContext = () => {
  var labelChildContext = (0, import_react23.useContext)(PolarLabelContext);
...
function Label(outerProps) {
  ...
  if (!viewBox || isNullish(value) && isNullish(children) && !/* @__PURE__ */ (0, import_react23.isValidElement)(content) && typeof content !== "function") {
    return null;
  }
  var propsWithViewBox = _objectSpread26(_objectSpread26({}, props), {}, {
    viewBox
  });
  if (/* @__PURE__ */ (0, import_react23.isValidElement)(content)) {
    var {
      labelRef: _
    } = propsWithViewBox, propsWithoutLabelRef = _objectWithoutProperties8(propsWithViewBox, _excluded8);
    return /* @__PURE__ */ (0, import_react23.cloneElement)(content, propsWithoutLabelRef);
  }
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties8(propsWithViewBox, _excluded24);
    label = /* @__PURE__ */ (0, import_react23.createElement)(content, propsForContent);
    if (/* @__PURE__ */ (0, import_react23.isValidElement)(label)) {
      return label;
    }
  } else {
  ...
  if (isPolar(viewBox)) {
    ...
    positionAttrs = _objectSpread26(_objectSpread26({
      x: cartesianResult.x,
      y: cartesianResult.y,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (/* @__PURE__ */ (0, import_react23.isValidElement)(label)) {
    if (label.type === Label) {
      return /* @__PURE__ */ (0, import_react23.cloneElement)(label, _objectSpread26({
        key: "label-implicit"
      }, commonProps));
    }
    return /* @__PURE__ */ React16.createElement(Label, _extends12({
...
var CartesianLabelListContext = /* @__PURE__ */ (0, import_react24.createContext)(void 0);
var CartesianLabelListContextProvider = CartesianLabelListContext.Provider;
var PolarLabelListContext = /* @__PURE__ */ (0, import_react24.createContext)(void 0);
var PolarLabelListContextProvider = PolarLabelListContext.Provider;
function useCartesianLabelListContext() {
  return (0, import_react24.useContext)(CartesianLabelListContext);
}
function usePolarLabelListContext() {
  return (0, import_react24.useContext)(PolarLabelListContext);
}
function LabelList(_ref2) {
  ...
  var {
    ...
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties9(restProps, _excluded25);
...
var getTrapezoidPath = (x2, y2, upperWidth, lowerWidth, height) => {
  ...
  var path2;
  path2 = roundTemplateLiteral(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral3(["M ", ",", ""])), x2, y2);
  path2 += roundTemplateLiteral(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral3(["L ", ",", ""])), x2 + upperWidth, y2);
  path2 += roundTemplateLiteral(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral3(["L ", ",", ""])), x2 + upperWidth - widthGap / 2, y2 + height);
  path2 += roundTemplateLiteral(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral3(["L ", ",", ""])), x2 + upperWidth - widthGap / 2 - lowerWidth, y2 + height);
  path2 += roundTemplateLiteral(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral3(["L ", ",", " Z"])), x2, y2);
  return path2;
};
...
var Trapezoid = (outsideProps) => {
  ...
  var prevUpperWidthRef = (0, import_react26.useRef)(upperWidth);
  var prevLowerWidthRef = (0, import_react26.useRef)(lowerWidth);
  var prevHeightRef = (0, import_react26.useRef)(height);
  var prevXRef = (0, import_react26.useRef)(x2);
  var prevYRef = (0, import_react26.useRef)(y2);
  ...
  return /* @__PURE__ */ React19.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ React19.createElement("path", _extends15({}, svgPropertiesAndEvents(trapezoidProps), {
      ...
      ref: pathRef,
      style: _objectSpread27(_objectSpread27({}, animationStyle), trapezoidProps.style)
    }));
  });
};

// node_modules/recharts/es6/util/ActiveShapeUtils.js
var _excluded10 = ["option", "shapeType", "activeClassName", "inActiveClassName"];
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ (0, import_react27.isValidElement)(option)) {
    shape = /* @__PURE__ */ (0, import_react27.cloneElement)(option, _objectSpread28(_objectSpread28({}, props), getPropsFromShapeOption(option)));
...
function SetTooltipEntrySettings(_ref2) {
  ...
  var dispatch = useAppDispatch();
  var isPanorama = useIsPanorama();
  var prevSettingsRef = (0, import_react28.useRef)(null);
...
function SetLegendPayload(_ref2) {
  ...
  var dispatch = useAppDispatch();
  var isPanorama = useIsPanorama();
  var prevPayloadRef = (0, import_react29.useRef)(null);
...
// node_modules/recharts/es6/context/RegisterGraphicalItemId.js
var GraphicalItemIdContext = /* @__PURE__ */ (0, import_react30.createContext)(void 0);
...
var SetCartesianGraphicalItemImpl = (props) => {
  var dispatch = useAppDispatch();
  var prevPropsRef = (0, import_react31.useRef)(null);
...
var SetCartesianGraphicalItem = /* @__PURE__ */ (0, import_react31.memo)(SetCartesianGraphicalItemImpl);
...
function DotItem(_ref2) {
  ...
  if (/* @__PURE__ */ (0, import_react32.isValidElement)(option)) {
    return /* @__PURE__ */ (0, import_react32.cloneElement)(option, dotProps);
  }
  if (typeof option === "function") {
...
function Dots(_ref3) {
  ...
  var dots = points.map((entry, i) => {
    ...
    var dotProps = _objectSpread29(_objectSpread29(_objectSpread29({
      r: 3
...
var ActivePoint = (_ref2) => {
  ...
  var dotProps = _objectSpread31(_objectSpread31(_objectSpread31({}, dotPropsTyped), svgPropertiesNoEventsFromUnknown(activeDot)), adaptEventHandlers(activeDot));
  var dot;
  if (/* @__PURE__ */ (0, import_react33.isValidElement)(activeDot)) {
    dot = /* @__PURE__ */ (0, import_react33.cloneElement)(activeDot, dotProps);
...
var ClipPathProvider = (_ref2) => {
  ...
  var [clipPathId] = (0, import_react35.useState)("".concat(uniqueId("recharts"), "-clip"));
...
// node_modules/recharts/es6/cartesian/CartesianAxis.js
var _excluded12 = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType", "axisId"];
...
function AxisLine(axisLineProps) {
  ...
  return /* @__PURE__ */ React26.createElement("line", _extends17({}, props, {
...
function TickItem(props) {
  ...
  if (/* @__PURE__ */ React26.isValidElement(option)) {
    tickItem = /* @__PURE__ */ React26.cloneElement(option, _objectSpread33(_objectSpread33({}, tickProps), {}, {
    ...
    tickItem = /* @__PURE__ */ React26.createElement(Text, _extends17({}, tickProps, {
      className
    }), value);
  }
  return tickItem;
...
var Ticks = /* @__PURE__ */ (0, import_react36.forwardRef)((props, ref) => {
  var {
    ticks: ticks2 = [],
    tick,
    tickLine,
  ...
  var tickLines = tickLineCoords.map((_ref2) => {
    ...
    }, tickLine && /* @__PURE__ */ React26.createElement("line", _extends17({}, tickLineProps, lineCoord, {
  ...
  var tickLabels = tickLineCoords.map((_ref3, i) => {
    ...
    var finalTickProps = _objectSpread33(_objectSpread33({}, tickProps), customTickProps);
    ...
    }, adaptEventsOfChild(events, entry, i)), tick && /* @__PURE__ */ React26.createElement(TickItem, {
      option: tick,
  ...
  }, /* @__PURE__ */ React26.createElement(RenderedTicksReporter, {
    ticks: finalTicks,
    axisId,
    axisType
  }), tickLabels.length > 0 && /* @__PURE__ */ React26.createElement(ZIndexLayer, {
    zIndex: DefaultZIndexes.label
  }, /* @__PURE__ */ React26.createElement("g", {
    className: "recharts-cartesian-axis-tick-labels recharts-".concat(axisType, "-tick-labels"),
    ref
  }, tickLabels)), tickLines.length > 0 && /* @__PURE__ */ React26.createElement("g", {
    className: "recharts-cartesian-axis-tick-lines recharts-".concat(axisType, "-tick-lines")
  }, tickLines));
});
var CartesianAxisComponent = /* @__PURE__ */ (0, import_react36.forwardRef)((props, ref) => {
  var {
    axisLine,
    width,
    height,
  ...
  var [fontSize, setFontSize] = (0, import_react36.useState)("");
  var [letterSpacing, setLetterSpacing] = (0, import_react36.useState)("");
  var tickRefs = (0, import_react36.useRef)(null);
  ...
  var layerRef = (0, import_react36.useCallback)((el) => {
    if (el) {
  ...
  return /* @__PURE__ */ React26.createElement(ZIndexLayer, {
  ...
  }, /* @__PURE__ */ React26.createElement(AxisLine, {
    x: props.x,
    y: props.y,
    width,
    height,
  ...
  }), /* @__PURE__ */ React26.createElement(Ticks, {
    ref: layerRef,
    axisType,
    events: rest,
    fontSize,
    ...
    y: props.y,
    axisId
  }), /* @__PURE__ */ React26.createElement(CartesianLabelContextProvider, {
    x: props.x,
    y: props.y,
    width: props.width,
    height: props.height,
...
var CartesianAxis = /* @__PURE__ */ React26.forwardRef((outsideProps, ref) => {
  var props = resolveDefaultProps(outsideProps, defaultCartesianAxisProps);
  return /* @__PURE__ */ React26.createElement(CartesianAxisComponent, _extends17({}, props, {
    ref
  }));
});
...
function LineItem(_ref2) {
  ...
  if (/* @__PURE__ */ React27.isValidElement(option)) {
    lineItem = /* @__PURE__ */ React27.cloneElement(option, lineItemProps);
  } else if (typeof option === "function") {
    ...
    var {
      ...
      y2,
      key
    } = lineItemProps, others = _objectWithoutProperties13(lineItemProps, _excluded13);
    ...
    lineItem = /* @__PURE__ */ React27.createElement("line", _extends18({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties13(props, _excluded32);
  var items = horizontalPoints.map((entry, i) => {
    ...
    return /* @__PURE__ */ React27.createElement(LineItem, {
      key: "line-".concat(i),
      option: horizontal,
      lineItemProps
    });
...
function VerticalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties13(props, _excluded42);
...
function CartesianGrid(props) {
  ...
  }, /* @__PURE__ */ React27.createElement(Background, {
  ...
  }), /* @__PURE__ */ React27.createElement(HorizontalStripes, _extends18({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ React27.createElement(VerticalStripes, _extends18({}, propsIncludingDefaults, {
    verticalPoints
  })), /* @__PURE__ */ React27.createElement(HorizontalGridLines, _extends18({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ React27.createElement(VerticalGridLines, _extends18({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
...
var ErrorBarContext = /* @__PURE__ */ (0, import_react37.createContext)(initialContextState);
function SetErrorBarContext(props) {
  var {
    children
  } = props, rest = _objectWithoutProperties14(props, _excluded14);
  return /* @__PURE__ */ React28.createElement(ErrorBarContext.Provider, {
    value: rest
  }, children);
}
...
function GraphicalItemClipPath(_ref2) {
  ...
  return /* @__PURE__ */ React29.createElement("clipPath", {
...
var SetLineTooltipEntrySettings = /* @__PURE__ */ React30.memo((_ref2) => {
  var {
    dataKey,
    data,
    stroke,
...
function StaticCurve(_ref4) {
  ...
  var {
    ...
    needClip,
    shape
  } = props, others = _objectWithoutProperties15(props, _excluded27);
  var curveProps = _objectSpread35(_objectSpread35({}, svgPropertiesAndEvents(others)), {}, {
    fill: "none",
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ React30.createElement(Shape, _extends19({
    shapeType: "curve",
    option: shape
  }, curveProps, {
    pathRef
  })), /* @__PURE__ */ React30.createElement(LineDotsWrapper, {
    points,
    clipPathId,
    props
  }));
...
function CurveWithAnimation(_ref5) {
  ...
  var animationIdRef = (0, import_react38.useRef)(animationId);
  var [isAnimating, setIsAnimating] = (0, import_react38.useState)(false);
  ...
  var startingPointRef = (0, import_react38.useRef)(0);
  ...
  return /* @__PURE__ */ React30.createElement(LineLabelListProvider, {
    points,
    showLabels
    ...
    if (prevPoints) {
      ...
      return /* @__PURE__ */ React30.createElement(StaticCurve, {
        props,
        points: stepData,
        clipPathId,
        pathRef,
...
function RenderCurve(_ref6) {
  ...
  var previousPointsRef = (0, import_react38.useRef)(null);
  var longestAnimatedLengthRef = (0, import_react38.useRef)(0);
  var pathRef = (0, import_react38.useRef)(null);
  return /* @__PURE__ */ React30.createElement(CurveWithAnimation, {
    props,
    clipPathId,
    previousPointsRef,
    longestAnimatedLengthRef,
...
var LineWithState = class extends import_react38.Component {
  render() {
    var {
      hide,
      dot,
    ...
    }))), /* @__PURE__ */ React30.createElement(SetErrorBarContext, {
      xAxisId,
      yAxisId,
      data: points,
      dataPointFormatter: errorBarDataPointFormatter,
      errorBarOffset: 0
    }, /* @__PURE__ */ React30.createElement(RenderCurve, {
      props: this.props,
      clipPathId
...
function LineImpl(props) {
  ...
  return /* @__PURE__ */ React30.createElement(LineWithState, _extends19({}, everythingElse, {
    id,
    connectNulls,
    dot,
    activeDot,
...
function LineFn(outsideProps) {
  ...
  return /* @__PURE__ */ React30.createElement(RegisterGraphicalItemId, {
  ...
  }), /* @__PURE__ */ React30.createElement(SetLineTooltipEntrySettings, {
    ...
    hide: props.hide,
    isPanorama
  }), /* @__PURE__ */ React30.createElement(LineImpl, _extends19({}, props, {
    id
  }))));
}
var Line = /* @__PURE__ */ React30.memo(LineFn, propsAreEqual);
...
function axisPropsAreEqual(prevProps, nextProps) {
  ...
  var {
    domain: prevDomain,
    range: prevRange
  } = prevProps, prevRest = _objectWithoutProperties16(prevProps, _excluded16);
  var {
    domain: nextDomain,
    range: nextRange
  } = nextProps, nextRest = _objectWithoutProperties16(nextProps, _excluded28);
...
var XAxisImpl = (props) => {
  ...
  return /* @__PURE__ */ React31.createElement(CartesianAxis, _extends20({}, allOtherProps, restSynchronizedSettings, {
    x: position.x,
    y: position.y,
...
function SetYAxisSettings(props) {
  var dispatch = useAppDispatch();
  var prevSettingsRef = (0, import_react40.useRef)(null);
  var layout = useCartesianChartLayout();
  var {
    type: typeFromProps
  ...
  var settings = (0, import_react40.useMemo)(() => {
    if (evaluatedType == null) {
      return void 0;
    }
    return _objectSpread37(_objectSpread37({}, restProps), {}, {
      type: evaluatedType
    });
...
function YAxisImpl(props) {
  ...
  var cartesianAxisRef = (0, import_react40.useRef)(null);
  var labelRef = (0, import_react40.useRef)(null);
  var viewBox = useAppSelector(selectAxisViewBox);
  var isPanorama = useIsPanorama();
  var dispatch = useAppDispatch();
  var axisType = "yAxis";
  ...
  (0, import_react40.useLayoutEffect)(() => {
    if (width !== "auto" || !axisSize || isLabelContentAFunction(label) || /* @__PURE__ */ (0, import_react40.isValidElement)(label) || synchronizedSettings == null) {
      return;
    }
  ...
  var {
    ...
    ticks: ticks2,
    scale: del
  } = props, allOtherProps = _objectWithoutProperties18(props, _excluded210);
  var {
    id,
    scale: del2
  } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties18(synchronizedSettings, _excluded35);
  return /* @__PURE__ */ React32.createElement(CartesianAxis, _extends21({}, allOtherProps, restSynchronizedSettings, {
...
function RechartsStoreProvider(_ref2) {
  ...
  var isPanorama = useIsPanorama();
  var storeRef = (0, import_react41.useRef)(null);
  if (isPanorama) {
    return children;
  }
...
var ReportEventSettings = /* @__PURE__ */ (0, import_react44.memo)(ReportEventSettingsImpl, propsAreEqual);
...
var MainChartSurface = /* @__PURE__ */ (0, import_react46.forwardRef)((props, ref) => {
...
var RootSurface = /* @__PURE__ */ (0, import_react46.forwardRef)((_ref2, ref) => {
  ...
  return /* @__PURE__ */ React35.createElement(MainChartSurface, _extends22({
    ref
...
function useReportScale() {
  var dispatch = useAppDispatch();
  var [ref, setRef] = (0, import_react47.useState)(null);
...
var ResponsiveDiv = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
  var _props$style, _props$style2;
  var observerRef = (0, import_react48.useRef)(null);
  var [sizes, setSizes] = (0, import_react48.useState)({
  ...
  var setContainerSize = (0, import_react48.useCallback)((newWidth, newHeight) => {
    setSizes((prevState) => {
      var roundedWidth = Math.round(newWidth);
      var roundedHeight = Math.round(newHeight);
      if (prevState.containerWidth === roundedWidth && prevState.containerHeight === roundedHeight) {
  ...
  var innerRef = (0, import_react48.useCallback)((node) => {
  ...
  }), /* @__PURE__ */ React36.createElement("div", _extends23({
    ref: innerRef
  }, props)));
});
var ReadSizeOnceDiv = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
  var {
    width,
    height
  } = props;
...
var StaticDiv = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
  var {
    width,
    height
  } = props;
...
var NonResponsiveDiv = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
  var {
    width,
    height
  } = props;
  if (typeof width === "string" || typeof height === "string") {
    return /* @__PURE__ */ React36.createElement(ReadSizeOnceDiv, _extends23({}, props, {
      ref
    }));
  }
  if (typeof width === "number" && typeof height === "number") {
    return /* @__PURE__ */ React36.createElement(StaticDiv, _extends23({}, props, {
      width,
      height,
      ref
    }));
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
  var {
    children,
    className,
    height: heightFromProps,
  ...
  var dispatch = useAppDispatch();
  var [tooltipPortal, setTooltipPortal] = (0, import_react48.useState)(null);
  var [legendPortal, setLegendPortal] = (0, import_react48.useState)(null);
  ...
  var myOnClick = (0, import_react48.useCallback)((e) => {
  ...
  var myOnMouseEnter = (0, import_react48.useCallback)((e) => {
  ...
  var myOnMouseLeave = (0, import_react48.useCallback)((e) => {
  ...
  var myOnMouseMove = (0, import_react48.useCallback)((e) => {
    dispatch(mouseMoveAction(e));
    dispatch(externalEventAction({
      handler: onMouseMove,
      reactEvent: e
  ...
  var onFocus = (0, import_react48.useCallback)(() => {
    dispatch(focusAction());
  }, [dispatch]);
  var onBlur = (0, import_react48.useCallback)(() => {
    dispatch(blurAction());
  }, [dispatch]);
  var onKeyDown = (0, import_react48.useCallback)((e) => {
    dispatch(keyDownAction(e.key));
  }, [dispatch]);
  var myOnContextMenu = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onContextMenu,
      reactEvent: e
    }));
  }, [dispatch, onContextMenu]);
  var myOnDoubleClick = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onDoubleClick,
      reactEvent: e
    }));
  }, [dispatch, onDoubleClick]);
  var myOnMouseDown = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onMouseDown,
      reactEvent: e
    }));
  }, [dispatch, onMouseDown]);
  var myOnMouseUp = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onMouseUp,
      reactEvent: e
    }));
  }, [dispatch, onMouseUp]);
  var myOnTouchStart = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onTouchStart,
      reactEvent: e
    }));
  }, [dispatch, onTouchStart]);
  var myOnTouchMove = (0, import_react48.useCallback)((e) => {
  ...
  var myOnTouchEnd = (0, import_react48.useCallback)((e) => {
    dispatch(externalEventAction({
      handler: onTouchEnd,
      reactEvent: e
    }));
...
var CategoricalChart = /* @__PURE__ */ (0, import_react49.forwardRef)((props, ref) => {
  var {
    width,
    height,
    responsive,
...
var defaultCartesianChartProps = _objectSpread39({
  accessibilityLayer: true,
  barCategoryGap: "10%",
  barGap: 4,
  layout: "horizontal",
...
var CartesianChart = /* @__PURE__ */ (0, import_react50.forwardRef)(function CartesianChart2(props, ref) {
  ...
  }), /* @__PURE__ */ React38.createElement(ReportEventSettings, {
  ...
  }), /* @__PURE__ */ React38.createElement(CategoricalChart, _extends24({}, rootChartProps, {
    ref
  })));
});
...
var LineChart = /* @__PURE__ */ (0, import_react51.forwardRef)((props, ref) => {
  return /* @__PURE__ */ React39.createElement(CartesianChart, {
    chartName: "LineChart",
    defaultTooltipEventType: "axis",
...
function StockChart({ data }) {
  ...
  const normalized = items.map((d) => {
    ...
    if (d.value > max2) {
      isOverflow = true;
      value = Math.min(d.value, max2);
    } else if (d.value < min2) {
      isOverflow = true;
      value = Math.max(d.value, min2);
    } else {
      isOverflow = false;
      value = d.value;
    }
  ...
  return /* @__PURE__ */ import_react52.default.createElement("div", { style: { width: "400px", height: "400px" } }, /* @__PURE__ */ import_react52.default.createElement(ResponsiveContainer, { width: "100%", height: "100%" }, /* @__PURE__ */ import_react52.default.createElement(LineChart, { data: normalized }, /* @__PURE__ */ import_react52.default.createElement(CartesianGrid, null), /* @__PURE__ */ import_react52.default.createElement(
    XAxis,
    {
      dataKey: "date",
  ...
  ), /* @__PURE__ */ import_react52.default.createElement(YAxis, { domain: [min2, max2] }), /* @__PURE__ */ import_react52.default.createElement(Tooltip, null), /* @__PURE__ */ import_react52.default.createElement(
    Line,
    {
      dataKey: "value",
      dot: /* @__PURE__ */ import_react52.default.createElement(Dot2, null),
      name: "META",
      stroke: "#0088FE",
      type: "linear"
    }
...
*/
//# sourceMappingURL=/assets/stock_chart.js.map
